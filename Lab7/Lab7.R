household_power_consumption <- read.csv("C:/Users/course009.FSKTM/Desktop/Lab7/household_power_consumption.txt")
view(household_power_consumption)

setwd("C:/Users/course009.FSKTM/Desktop/Lab7/household_power_consumption.txt")
